...
Сайт был изначально сверстан в рамках учебного интенсива. Спустя время, я вернулся к нему и решил доработать его. А по факту переработать, чтобы применить полученные за это время знания. По сутит решил провести рефакторинг своего изначального кода, плюс добавить адаптив.
